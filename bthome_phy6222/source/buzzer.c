...
#define N_T2    16 // 1.5/4

#define NOTE_TEMP 55

const uint8_t melody[] = {  // Note, Time in 10 ms
	// Define the melody for "Never Gonna Give You Up"

NOTE_D5,N_T4N,NOTE_E5,N_T4N,NOTE_A4,N_T4,//1
NOTE_E5,N_T4N,NOTE_FS5,N_T4N,NOTE_A5,N_T16,NOTE_G5,N_T16,NOTE_FS5,N_T8,
NOTE_D5,N_T4N,NOTE_E5,N_T4N,NOTE_A4,N_T2,
NOTE_A4,N_T16,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T8,NOTE_D5,N_T16,
NOTE_D5,N_T4N,NOTE_E5,N_T4N,NOTE_A4,N_T4,//repeatfrom1
NOTE_E5,N_T4N,NOTE_FS5,N_T4N,NOTE_A5,N_T16,NOTE_G5,N_T16,NOTE_FS5,N_T8,
NOTE_D5,N_T4N,NOTE_E5,N_T4N,NOTE_A4,N_T2,
NOTE_A4,N_T16,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T8,NOTE_D5,N_T16,
REST,N_T4,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_D5,N_T8,NOTE_E5,N_T8,NOTE_CS5,N_T8N,
NOTE_B4,N_T16,NOTE_A4,N_T2,REST,N_T4,
NOTE_REST,30,
REST,N_T8,NOTE_B4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T4,NOTE_A4,N_T8,//7
NOTE_A5,N_T8,REST,N_T8,NOTE_A5,N_T8,NOTE_E5,N_T4N,REST,N_T4,
NOTE_B4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,NOTE_D5,N_T8,NOTE_E5,N_T8,REST,N_T8,
REST,N_T8,NOTE_CS5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4N,REST,N_T4,
REST,N_T8,NOTE_B4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4,
NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T4,REST,N_T4,
NOTE_REST,30,

NOTE_D5,N_T2,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_D5,N_T8,//13
NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T4,NOTE_A4,N_T4,
REST,N_T2,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,
REST,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_REST,30,

NOTE_E5,N_T8N,NOTE_E5,N_T8N,NOTE_D5,N_T8N,NOTE_CS5,N_T16,NOTE_B4,N_T8N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,//18
NOTE_D5,N_T4,NOTE_E5,N_T8,NOTE_CS5,N_T8N,NOTE_B4,N_T16,NOTE_A4,N_T8,NOTE_A4,N_T8,NOTE_A4,N_T8,
NOTE_E5,N_T4,NOTE_D5,N_T2,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_A5,N_T4,NOTE_CS5,N_T8,NOTE_D5,N_T8N,NOTE_CS5,N_T16,NOTE_B4,N_T8,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_REST,30,

NOTE_D5,N_T4,NOTE_E5,N_T8,NOTE_CS5,N_T8N,NOTE_B4,N_T16,NOTE_A4,N_T4,NOTE_A4,N_T8,//23
NOTE_E5,N_T4,NOTE_D5,N_T2,REST,N_T4,
REST,N_T8,NOTE_B4,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,NOTE_D5,N_T8,NOTE_E5,N_T4,REST,N_T8,
REST,N_T8,NOTE_CS5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4N,REST,N_T4,
REST,N_T8,NOTE_B4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4,
REST,N_T8,NOTE_A5,N_T8,NOTE_A5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T8,NOTE_D5,N_T8,
NOTE_REST,30,

REST,N_T8,NOTE_A4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,//29
REST,N_T8,NOTE_CS5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4N,REST,N_T4,
NOTE_B4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,NOTE_A4,N_T4,REST,N_T8,
REST,N_T8,NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T4,NOTE_E5,N_T4N,
NOTE_D5,N_T2,NOTE_D5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T4,
NOTE_E5,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T8,NOTE_A4,N_T8,NOTE_A4,N_T4,
NOTE_REST,30,

REST,N_T4N,NOTE_A4,N_T8,NOTE_B4,N_T8,NOTE_CS5,N_T8,NOTE_D5,N_T8,NOTE_B4,N_T8,//35
REST,N_T8,NOTE_E5,N_T8,NOTE_FS5,N_T8,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_E5,N_T8N,NOTE_E5,N_T8N,NOTE_D5,N_T8N,NOTE_CS5,N_T16,NOTE_B4,N_T8,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_D5,N_T4,NOTE_E5,N_T8,NOTE_CS5,N_T8N,NOTE_B4,N_T16,NOTE_A4,N_T4,NOTE_A4,N_T8,
NOTE_REST,30,

NOTE_E5,N_T4,NOTE_D5,N_T2,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,//40
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_A5,N_T4,NOTE_CS5,N_T8,NOTE_D5,N_T8N,NOTE_CS5,N_T16,NOTE_B4,N_T8,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_D5,N_T4,NOTE_E5,N_T8,NOTE_CS5,N_T8N,NOTE_B4,N_T16,NOTE_A4,N_T4,NOTE_A4,N_T8,
NOTE_E5,N_T4,NOTE_D5,N_T2,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
...
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,//45
NOTE_A5,N_T4,NOTE_CS5,N_T8,NOTE_D5,N_T8N,NOTE_CS5,N_T16,NOTE_B4,N_T8,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_D5,N_T4,NOTE_E5,N_T8,NOTE_CS5,N_T8N,NOTE_B4,N_T16,NOTE_A4,N_T4,NOTE_A4,N_T8,
NOTE_E5,N_T4,NOTE_D5,N_T2,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,
NOTE_FS5,N_T8N,NOTE_FS5,N_T8N,NOTE_E5,N_T4N,NOTE_A4,N_T16,NOTE_B4,N_T16,NOTE_D5,N_T16,NOTE_B4,N_T16,//45
...
static void set_buzzer_pwm(uint8_t tone) {
 ...
 void pwm_buzzer_note(uint8_t tone) {
	if(tone == NOTE_REST) {
