...
uint8_t apple_findmy_key[SIZE_APPLE_FINDMY_KEY]={
    0x92, 0x8f, 0x22, 0xcf, 0x28, 0x03, 0x44, 0x5e,
    0xf1, 0x41, 0xbf, 0x9a, 0x9d, 0x23, 0x80, 0x65,
    0x7b, 0x0d, 0x46, 0xac, 0x76, 0xba, 0x72, 0x4a,
    0xe7, 0xd5, 0x60, 0xfe
};
...
static const uint8 google_findmy_head[] = {
	...
	0x40   // FMDN frame type with unwanted tracking protection mode indication
};
